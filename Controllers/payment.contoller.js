...
const cancelSubscription = async (req,res,next) =>{
    ...
    await user.save()
        ...
        return next(new AppError( error.message||"Unable to purchase a Subscription",402))
...
const allPayment = async (req,res,next) =>{
    ...
    res.status(200).json({
        ...
        return next(new AppError( error.message||"Unable to get details of Subscription Payment",402))
